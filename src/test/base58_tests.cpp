...
BOOST_AUTO_TEST_CASE(base58_DecodeBase58)
{
    ...
    BOOST_CHECK(!DecodeBase58(std::string("invalid", 8), result, 100));
    BOOST_CHECK(!DecodeBase58(std::string("\0invalid", 8), result, 100));

    BOOST_CHECK(DecodeBase58(std::string("good"), result, 100));
    BOOST_CHECK(!DecodeBase58(std::string("bad0IOl"), result, 100));
    BOOST_CHECK(!DecodeBase58(std::string("goodbad0IOl"), result, 100));
    ...
    BOOST_CHECK(DecodeBase58Check(std::string("3vQB7B6MrGQZaxCuFg4oh"), result, 100));
    BOOST_CHECK(!DecodeBase58Check(std::string("3vQB7B6MrGQZaxCuFg4oi"), result, 100));
    BOOST_CHECK(!DecodeBase58Check(std::string("3vQB7B6MrGQZaxCuFg4oh0IOl"), result, 100));
    BOOST_CHECK(!DecodeBase58Check(std::string("3vQB7B6MrGQZaxCuFg4oh\0" "0IOl", 26), result, 100));
}
